          ...
          <div className="flex flex-1 items-center justify-end gap-3">
            {!isAuthChecked ? (
              ...
              <button
                ...
                className="flex cursor-pointer items-center gap-2 rounded-lg border border-white/20 bg-emerald-500 px-4 py-1.5 text-sm font-bold transition-all duration-200 hover:bg-emerald-600 active:scale-95"
              >
